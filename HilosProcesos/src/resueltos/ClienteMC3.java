...
public class ClienteMC3 {

	public static void main(String[] args) throws Exception {

		System.out.println("Cliente 3 iniciado correctamente …");
		...
		while (!msg.trim().equals("fin")) {
			...
			System.out.println("Cliente 3 - Mensaje del Servidor: " + msg.trim());
		}
